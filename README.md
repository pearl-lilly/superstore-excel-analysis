...
To understand sales, profits, and losses across categories and regions in the superstore dataset, I asked this:
...
3.	**How do sales vary across different sub-categories and which segment drive the most revenue?
...
## Question1.  What has been the trend in profit by year, and how can it inform future financial planning?
...
## Question3.How do sales vary across different subcategories, and which segments drive the most revenue?
### Skill: Pivot Table, Pivot Chart
#### How I answered it:
...
#### 🤔 So What
Understanding which subcategories drive the most sales helps the business focus resources where they matter most.
Subcategories like Phones, Chairs, and Copiers are key revenue drivers , they can be prioritized for:
...
## What is the regional distribution of sales, and which regions offer the greatest growth potential?
### Skill: Pivot Table, Pivot Chart
#### How I Answered It
...
This indicates that sales are unevenly distributed, with the West and East regions leading in revenue.
#### 🤔 So What
...
## Who are the top 5 most profitable customers, and how can we enhance relationships with them?
...
## How do sales fluctuate by month, and what seasonal trends should be considered for inventory and marketing?
### Skill: Pivot Table, Pivot Chart, Date Formatting
### 🛠 How I Answered It
